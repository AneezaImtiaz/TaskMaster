...
export default {
    ...
    argTypes: {
        ...
        onCloseButtonClick: {
            description: 'Callback function when the close button is clicked (optional)',
    ...
    parameters: {
        docs: {
            description: {
                component: 'The `MessageDialog` component is used to display a dialog with a title, description, and buttons for user actions.',
            },
        },
    },
