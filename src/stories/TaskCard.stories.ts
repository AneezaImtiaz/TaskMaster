...
export default {
    ...
    parameters: {
        docs: {
            description: {
                component: 'The `TaskCard` component displays a task with options to edit or delete it.',
            },
        },
    },
    argTypes: {
...
LongTitleAndDescription.args = {
    task: {
        id: 2,
        title: 'This is a task with a very long title that might need to be truncated or handled in a special way',
        description: 'This is a task with a very long description that might need to be truncated or handled in a special way. It goes on and on and might span multiple lines.',
        status: 'Pending',
        dueDate: '2023-12-31',
    },
};
